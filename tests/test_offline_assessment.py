...
class OfflineAssessmentTest(TestCase):
    ...
    def test_assesses_locally_observable_jsonld_metadata(self):
        ...
        self.assertEqual("indeterminate", result["cells"]["f4"])
        self.assertEqual("indeterminate", result["cells"]["a1"])
        self.assertEqual("indeterminate", result["cells"]["a1_1"])
        self.assertEqual("indeterminate", result["cells"]["a1_2"])
        self.assertEqual("indeterminate", result["cells"]["a2"])
        self.assertEqual("pass", result["cells"]["i1"])
        self.assertEqual("indeterminate", result["cells"]["i2"])
